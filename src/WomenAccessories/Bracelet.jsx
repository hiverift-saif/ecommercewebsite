// src/WomenAccessories/Bracelet.jsx
...
export default function Bracelet() {
  ...
  const products = [
    {
      id: 701,
      title: "Gold-Plated Elegant Bracelet",
      category: "bracelet",
      originalPrice: 1499,
      salePrice: 899,
      discount: "-40%",
      ...
      <div className="flex-1 min-h-screen">
        ...
        <div className="mt-10 px-10 mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProducts.map((product, i) => (
            <div
              key={product.id}
              className="group relative bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition"
            >
              {/* IMAGE BLOCK */}
