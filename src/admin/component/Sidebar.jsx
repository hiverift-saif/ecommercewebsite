...
import { LayoutDashboard, ShoppingCart, Package, Users, Percent, X,RectangleHorizontal ,Settings,User } from "lucide-react";
...
>
      ...
      <button
        ...
        <nav className="space-y-6">
          <SidebarLink to="/admin" icon={<LayoutDashboard />} label="Dashboard" onClick={setMobileOpen} />
