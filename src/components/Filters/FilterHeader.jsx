  ...
  <span className="ml-2 text-gray-600">({total})</span>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <Grid
            size={20}
            className={`cursor-pointer ${gridCols === 2 ? "text-black" : "text-gray-400"}`}
            onClick={() => setGridCols(2)}
          />
          <Grid
            size={20}
            className={`cursor-pointer ${gridCols === 3 ? "text-black" : "text-gray-400"}`}
            onClick={() => setGridCols(3)}
          />
          <Grid
            size={20}
            className={`cursor-pointer ${gridCols === 4 ? "text-black" : "text-gray-400"}`}
            onClick={() => setGridCols(4)}
          />
          <List
            size={20}
            className={`cursor-pointer ${gridCols === 1 ? "text-black" : "text-gray-400"}`}
